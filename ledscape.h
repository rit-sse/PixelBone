...
extern ledscape_t *ledscape_init(unsigned num_pixels);

extern ledscape_frame_t *ledscape_frame(ledscape_t *const leds, unsigned frame);
...
extern void ledscape_close(ledscape_t *const leds);
